...
│   ├── 📄 __init__.py         # JWT configuration & helpers
│   └── 📁 v1/                 # Version 1 auth routes
│       ├── 📄 __init__.py
...
│                                                                  │
│   app/auth/                                                      │
│   ├── __init__.py          # JWT config (shared across versions)│
│   └── v1/                                                        │
...
| `app/auth/v1/routes.py` | Auth endpoints    | Modify authentication     |
